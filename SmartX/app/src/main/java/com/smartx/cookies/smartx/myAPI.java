...
public interface myAPI {
    ...
    void viewPlugs(@Path("userID") String id, @Path("roomID") String rid, Callback<List<Plug>> callback);
    ...
    @GET("/v/users/{userID}/rooms/{roomID}/plugs/{plugName}")
    void findPlug(@Path("userID") String userID, @Path("roomID") String roomID, @Path("plugName") String name, Callback<List<Device>> callback);
