...
public interface myAPI {
    ...
    void addNote(@Path("user_id") String userId, @Path("room_id") String roomId, @Path("device_device_id") String deviceID,@Field("note[body]") String noteText, Callback<Note> callback);
