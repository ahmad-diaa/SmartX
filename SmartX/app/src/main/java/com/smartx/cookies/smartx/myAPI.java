...
public interface myAPI {
    ...
    void addDevice(@Path("userId") String userId, @Path("roomId") String roomId,@Field("device[id]" )String deviceId ,@Field("device[name]") String name, @Field("device[status]") String status, Callback<Device> callback);
