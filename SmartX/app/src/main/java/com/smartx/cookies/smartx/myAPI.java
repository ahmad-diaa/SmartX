...
public interface myAPI {
    ...
    void getRoom(@Path("userID") String id, @Path("roomID") String roomID, Callback<Room> callback);
//    @GET("/users/{userID}/rooms/1")
//    void getRoom(@Path("userID") String id, Callback<Room> callback);
}
