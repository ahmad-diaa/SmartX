...
public class ViewRooms extends ListActivity {
    ...
    /**
     * When the user click on logout, this method is called, it sends a request to delete the user's session after it succeeds it renders login View after it sends
     *
